...
JD_REGISTER_POLL_STREAMING_INTERVAL = const(5000)
JD_REGISTER_POLL_FIRST_REPORT_INTERVAL = const(400)
JD_REGISTER_POLL_REPORT_INTERVAL = const(5001)
JD_REGISTER_POLL_REPORT_MAX_INTERVAL = const(60000)
JD_REGISTER_POLL_REPORT_VOLATILE_INTERVAL = const(1000)
JD_REGISTER_POLL_REPORT_VOLATILE_MAX_INTERVAL = const(5000)
JD_REGISTER_OPTIONAL_POLL_COUNT = const(3)
JD_STREAMING_DEFAULT_INTERVAL = const(50)

JD_LOGGER_LISTENER_TIMEOUT = const(3000)
...
DEVTOOLS_WS_PORT = const(8081)
DEVTOOLS_HTTP_PORT = const(8082)
