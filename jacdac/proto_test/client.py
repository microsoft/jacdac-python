...
class ProtoTestClient(Client):
    ...
    @property
    def rw_i8_u8_u16_i32I8(self) -> Optional[int]:
        """
    ...
    @property
    def rw_i8_u8_u16_i32U8(self) -> Optional[int]:
        """
        A read write i8, u8, u16, i32 register.
        """
        reg = self.register(JD_PROTO_TEST_REG_RW_I8_U8_U16_I32)
    ...
    @property
    def rw_i8_u8_u16_i32U16(self) -> Optional[int]:
        """
        A read write i8, u8, u16, i32 register.
        """
        reg = self.register(JD_PROTO_TEST_REG_RW_I8_U8_U16_I32)
    ...
    @property
    def rw_i8_u8_u16_i32I32(self) -> Optional[int]:
        """
        A read write i8, u8, u16, i32 register.
        """
        reg = self.register(JD_PROTO_TEST_REG_RW_I8_U8_U16_I32)
    ...
    @property
    def ro_i8_u8_u16_i32I8(self) -> Optional[int]:
        """
    ...
    @property
    def ro_i8_u8_u16_i32U8(self) -> Optional[int]:
        """
        A read only i8, u8, u16, i32 register.. Mirrors rw_i8_u8_u16_i32.
        """
        reg = self.register(JD_PROTO_TEST_REG_RO_I8_U8_U16_I32)
    ...
    @property
    def ro_i8_u8_u16_i32U16(self) -> Optional[int]:
        """
        A read only i8, u8, u16, i32 register.. Mirrors rw_i8_u8_u16_i32.
        """
        reg = self.register(JD_PROTO_TEST_REG_RO_I8_U8_U16_I32)
    ...
    @property
    def ro_i8_u8_u16_i32I32(self) -> Optional[int]:
        """
        A read only i8, u8, u16, i32 register.. Mirrors rw_i8_u8_u16_i32.
        """
        reg = self.register(JD_PROTO_TEST_REG_RO_I8_U8_U16_I32)
    ...
    @property
    def rw_u8_string_U8(self) -> Optional[int]:
        """
    ...
    @property
    def rw_u8_string_String(self) -> Optional[str]:
        """
        A read write u8, string register.
        """
        reg = self.register(JD_PROTO_TEST_REG_RW_U8_STRING)
    ...
    @property
    def ro_u8_string_U8(self) -> Optional[int]:
        """
    ...
    @property
    def ro_u8_string_String(self) -> Optional[str]:
        """
        A read only u8, string register.. Mirrors rw_u8_string.
        """
        reg = self.register(JD_PROTO_TEST_REG_RO_U8_STRING)
